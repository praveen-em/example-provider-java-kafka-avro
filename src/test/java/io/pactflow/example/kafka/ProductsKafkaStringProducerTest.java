...
//   public class ProductsKafkaStringProducerTest {
//   private static final Logger LOGGER = LoggerFactory.getLogger(ProductsKafkaStringProducerTest.class);
...
//     ProductEvent productEvent = new ProductEvent("id1", "product name", "product type", "v1", EventType.CREATED, 27.00);
//     Message<String> message = new StringMessageBuilder().withProduct(productEvent).build();
